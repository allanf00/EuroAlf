...
<body>
    <div class="container">
			...
			<div class="row">
				<p>
					<a href="crearucrania.php" class="btn btn-success">Crear</a>
				</p>
				...
				<table class="table table-striped table-bordered">
		              ...
		              <?php 
					   ...
					   $sql = 'SELECT * FROM ucrania ORDER BY dorsal ASC';
	 				   foreach ($pdo->query($sql) as $row) {
							   	...
							   	echo '<td width=250>';
							   	echo '<a class="btn" href="informacionucrania.php?id='.$row['id'].'">Informacion</a>';
							   	echo '&nbsp;';
							   	echo '<a class="btn btn-success" href="actualizarucrania.php?id='.$row['id'].'">Actualizar</a>';
							   	echo '&nbsp;';
							   	echo '<a class="btn btn-danger" href="borrarucrania.php?id='.$row['id'].'">Borrar</a>';
							   	echo '</td>';
							   	echo '</tr>';
