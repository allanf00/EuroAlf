...
<body>
    <div class="container">
			...
			<div class="row">
				<p>
					<a href="crearfrancia.php" class="btn btn-success">Crear</a>
				</p>
				...
				<table class="table table-striped table-bordered">
		              ...
		              <?php 
					   ...
					   $sql = 'SELECT * FROM francia ORDER BY dorsal ASC';
	 				   foreach ($pdo->query($sql) as $row) {
  								...
  								echo "<a href='rumania.php'>Rumanía</a> ";
							   	...
							   	echo '<td width=250>';
							   	echo '<a class="btn" href="informacionfrancia.php?id='.$row['id'].'">Informacion</a>';
							   	echo '&nbsp;';
							   	echo '<a class="btn btn-success" href="actualizarfrancia.php?id='.$row['id'].'">Actualizar</a>';
							   	echo '&nbsp;';
							   	echo '<a class="btn btn-danger" href="borrarfrancia.php?id='.$row['id'].'">Borrar</a>';
							   	echo '</td>';
							   	echo '</tr>';
