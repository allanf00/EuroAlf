...
<body>
    <div class="container">
    		<div class="row">
    			<h3>Irlanda del Norte</h3>
    		</div>
			<div class="row">
				<p>
					<a href="crearirlandadelnorte.php" class="btn btn-success">Crear</a>
				</p>
				...
				<table class="table table-striped table-bordered">
		              ...
		              <?php 
					   ...
					   $sql = 'SELECT * FROM irlandadelnorte ORDER BY dorsal ASC';
	 				   foreach ($pdo->query($sql) as $row) {
							   	...
							   	echo '<td width=250>';
							   	echo '<a class="btn" href="informacionirlandadelnorte.php?id='.$row['id'].'">Informacion</a>';
							   	echo '&nbsp;';
							   	echo '<a class="btn btn-success" href="actualizarirlandadelnorte.php?id='.$row['id'].'">Actualizar</a>';
							   	echo '&nbsp;';
							   	echo '<a class="btn btn-danger" href="borrarirlandadelnorte.php?id='.$row['id'].'">Borrar</a>';
							   	echo '</td>';
							   	echo '</tr>';
