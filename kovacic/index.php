...
<body  style="background-attachment: fixed" >
	...
	<table border="0" align="center" valign="middle">
		...
		<tr><td><label style="font-size: 14pt"><b>Correo: </b></label></td>
			<td width=80> <input class="form-group has-success" style="border-radius:15px;" type="text" name="email"></td></tr>
...
<form method="post" action="" >
  <fieldset>
    ...
    <div class="form-group">
      ...
      <input type="password" name="reppassword" class="form-control" required placeholder="repite contraseña" />
    </div>
